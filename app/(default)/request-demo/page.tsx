export const metadata = {
  title: 'Request Demo - BlueSwarm',
  description: 'See how BlueSwarm can transform your outreach strategy with intelligent AI swarms that drive more clients and strengthen your negotiation power.',
}
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="px-4 sm:px-6">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
              <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">Get started with BlueSwarm</h1>
              <p className="text-lg text-zinc-500">Talk to an expert about how BlueSwarm can transform your outreach strategy. Complete the form and we'll show you how intelligent AI swarms can drive more clients and strengthen your negotiation power.</p>
            </div>
