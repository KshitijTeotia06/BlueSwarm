...
import AgentTrackingInterface from '@/components/agent-tracking-interface'
  ...
  return (
    <section className="relative before:absolute before:inset-0 before:h-80 before:pointer-events-none before:bg-linear-to-b before:from-zinc-100 before:-z-10">
      <div className="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div className="px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                <h1 className="font-inter-tight text-4xl md:text-5xl font-bold text-zinc-800 pb-4">
                  Intelligent <em className="italic relative inline-flex justify-center items-center text-zinc-800"> distribution
                  ...
                  </em> powered by AI swarms
                </h1>
                <p className="text-lg text-zinc-500 mb-8">
                  BlueSwarm understands your company, continuously tracks your ICP and competitors, and delivers multi-channel outreach that builds trust before contracts.
                </p>
                <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <div className="relative">
                    <Link className="btn text-white bg-zinc-800 hover:bg-zinc-700 w-full shadow-lg px-6 py-3 text-base font-semibold transform hover:scale-105 transition-all duration-200 animate-purple-pulse relative z-10" href="https://calendly.com/kshitijt-berkeley" target="_blank" rel="noopener noreferrer">Request Demo</Link>
                  </div>
                  <div>
                    <a className="btn text-zinc-600 bg-white hover:text-zinc-900 w-full shadow-sm px-6 py-3 text-base font-semibold" href="#features">More Info</a>
                  </div>
                </div>
              </div>
          </div>
        ...
        {/* Agent Tracking Interface */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex justify-center pb-12 md:pb-20">
          <AgentTrackingInterface />
        </div>
