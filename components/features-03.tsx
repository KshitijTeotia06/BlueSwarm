  ...
  return (
    <section className="relative bg-zinc-800 after:absolute after:top-0 after:right-0 after:h-full after:w-96 after:pointer-events-none after:bg-linear-to-l after:from-zinc-800 max-lg:after:hidden">
      <div className="py-12 md:py-20">
        ...
        {/* Carousel */}
        <div className="max-w-xl lg:max-w-4xl mx-auto px-4 sm:px-6">
          {/* Content */}
          <div>
              <div className="mb-8">
                <div className="inline-flex text-sm font-medium text-zinc-400 px-4 py-0.5 border border-transparent [background:linear-gradient(var(--color-zinc-800),var(--color-zinc-800))_padding-box,linear-gradient(120deg,var(--color-zinc-700),--theme(--color-zinc-700/0),var(--color-zinc-700))_border-box] rounded-full mb-4">Trust Before Contracts</div>
                <h3 className="font-inter-tight text-3xl font-bold text-zinc-200 mb-4">Build relationships that drive revenue</h3>
                <p className="text-lg text-zinc-500">BlueSwarm provides real value, connection, and qualification before signing contracts—giving you more clients and stronger negotiation power.</p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0 space-y-2">
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Automated Strategy, Not Just Tools</div>
                    <div className="text-zinc-500">Unlike Agentforce, we don't require you to automate pre-existing strategies. BlueSwarm develops and executes intelligent outreach strategies autonomously.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Action, Not Just Analytics</div>
                    <div className="text-zinc-500">While Semrush gives you analytics with no action, BlueSwarm combines insights with automated creative outreach and multi-channel campaigns.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Beyond Email Research</div>
                    <div className="text-zinc-500">We don't just find customers for email outreach. BlueSwarm goes further—delivering multi-channel campaigns with in-person touchpoints and distribution analysis.</div>
                  </div>
                </button>
              </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">ICP Tracking</h3>
              </div>
              <p className="text-sm text-zinc-500">Continuous monitoring of your ideal customer profile with intelligent insights and opportunity identification.</p>
            </div>
            {/* Block #2 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Competitor Intelligence</h3>
              </div>
              <p className="text-sm text-zinc-500">Real-time competitor analysis and market positioning insights to stay ahead of the competition.</p>
            </div>
            {/* Block #3 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Distribution Channels</h3>
              </div>
              <p className="text-sm text-zinc-500">Comprehensive analysis of distribution channels and opportunities for maximum reach and impact.</p>
            </div>
            {/* Block #4 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Mass Campaigns</h3>
              </div>
              <p className="text-sm text-zinc-500">Execute multi-channel campaigns at scale that drive more clients and increase your negotiation power.</p>
            </div>
            {/* Block #5 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Qualification Engine</h3>
              </div>
              <p className="text-sm text-zinc-500">Automated qualification and value delivery to prospects before they become customers, building trust and relationships.</p>
            </div>
            {/* Block #6 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Value Delivery</h3>
              </div>
              <p className="text-sm text-zinc-500">Provide real value and connections to prospects through intelligent, personalized outreach that goes beyond cold emails.</p>
            </div>
          </div>
        </div>
