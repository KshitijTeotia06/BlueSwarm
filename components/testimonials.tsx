  ...
  const testimonials01 = [
    {
      ...
      user: '@linaj87',
      link: '#0',
      content: 'BlueSwarm transformed our outreach strategy. The multi-channel approach and continuous intelligence helped us close 3x more deals with better qualification.',
    },
    {
      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-200">Trusted by teams that value real relationships over cold outreach</h2>
          </div>
        </div>
