      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 mb-4">Ready to scale your outreach <em className="relative not-italic inline-flex justify-center items-end">
                with intelligence?
            ...
            <p className="text-lg text-zinc-500 mb-8">BlueSwarm understands your company and continuously works to build relationships that drive revenue. Start building trust before contracts today.</p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <div>
                <a className="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow-sm" href="https://calendly.com/kshitijt-berkeley" target="_blank" rel="noopener noreferrer">Request Demo</a>
              </div>
              <div>
                <a className="btn text-zinc-600 bg-white hover:text-zinc-900 w-full shadow-sm" href="#features">More Info</a>
              </div>
            </div>
          </div>
          {/* Clients */}
